...
<body class="d-flex">
  ...
  <div class="flex-grow-1 p-4">
    <h1 class="mb-2"><i class="fa-solid fa-user-tie profile-icon"></i> Hai, <?php echo htmlspecialchars($profil['nama']); ?>!</h1>
    <p class="text-secondary mb-4">Selamat datang di dashboard bidang. Kelola pengaduan dan data Anda di sini.</p>
